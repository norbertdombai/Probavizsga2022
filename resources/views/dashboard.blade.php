<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <thead>
                <tr>
                 <th id='szakdoga_nev'>Szakdolgozat címe</th>
                    <th id='tagokneve'>Készítők nevei</th>                    
                    <th id='githublink' >Github link</th>
                    <th id='oldallink' >Oldal link</th>
                </tr>
            </thead>
            <tbody id="szakdogalista">            
